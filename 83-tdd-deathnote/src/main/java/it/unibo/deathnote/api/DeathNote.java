...
public interface DeathNote {
     ...
     *
     * @param ruleNumber the number of the rule to return. The first rule has number
     *                   one
     * @return the rule with the given number
     * @throws IllegalArgumentException if the given rule number is smaller than 1
     *                                  or larger
    ...
    /**
     * If the cause of death is written within the next 40 milliseconds of writing
     * the person's
     * name, it will happen.
     *
    ...
    /**
     * After writing the cause of death, details of the death should be written in
     * the next
     * 6 seconds and 40 milliseconds.
     *
     * @param details the details of the human's death
     * @return true if the details were written within 6 seconds and 40
     ...
     *         If the cause of death is not specified, the method will return "heart
     *         attack".
     * @throws IllegalArgumentException if the provider name is not written in this
     *                                  DeathNote
     */
